...
class TestBotRouting(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.bot.enhanced_system = MagicMock()
    ...
    def test_fast_path_for_help_command(self):
        ...
        self.bot.enhanced_system.process_query.assert_not_called()

    def test_full_path_for_complex_query(self):
        ...
        # Assert that the AI system WAS called
        self.bot.enhanced_system.process_query.assert_called_once()
